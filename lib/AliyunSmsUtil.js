...
var AliyunSmsUtil = {
  config: {
    ...
    AccessKeyId: 'LTAIIWmvLEiGrAFm', //阿里短信服务所用的密钥ID
    AccessKeySecret: 'CjWmzSYORoquWZjkY13NWLSFWF19vG', //阿里短信服务所用的密钥值
    TemplateCode: 'SMS_56055145', //阿里短信模板CODE
    SignName: 'junfoinfo.com', //短信签名名称
  ...
  /**
     ...
     */
  test: function() {
    var data = { code: '1234', phone: '18672927640' };
